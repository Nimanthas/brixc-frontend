                                            ...
                                            <div className="widget-chart p-0">
                                                <div className="widget-chart-content">
                                                    <div className="widget-description mt-0 text-warning">
                                                        ...
                                                        <span className="text-muted opacity-8 pl-1">increased resources</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="widget-content-outer">
                                            ...
                                            <div className="widget-content-left fsize-1">
                                                <div className="text-muted opacity-6">Inflow Target</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="card-shadow-success mb-3 widget-chart widget-chart2 text-left card">
                                    <div className="widget-content">
                                        <div className="widget-content-outer">
                                            ...
                                            <div className="widget-content-left fsize-1">
                                                <div className="text-muted opacity-6">Outflow Target</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="card-shadow-warning mb-3 widget-chart widget-chart2 text-left card">
                                    <div className="widget-content">
                                        <div className="widget-content-outer">
                                            ...
                                            <div className="widget-content-left fsize-1">
                                                <div className="text-muted opacity-6">Manage Target</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Row>
                            <Col md="12">
                                <Card className="main-card mb-3">
                                    <div className="card-header">Active Plans
                                        <div className="btn-actions-pane-right">
                                            <div role="group" className="btn-group-sm btn-group">
                                                <button className="active btn btn-info">Today</button>
                                                <button className="btn btn-info">This Week</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="d-block text-center card-footer">
                                        ...
                                        <button className="btn-wide btn btn-success">Refresh</button>
                                    </div>
                                </Card>
                            </Col>
                        </Row>
